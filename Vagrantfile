...
#      ansible.playbook = "deploy_matlabRH7.yml"
##     ansible.groups = {
...
# end
  config.vm.define "matlabRH7" do |sasRH7|
    matlabRH7.vm.box = "clouddood/RH7.5_baserepo"
    matlabRH7.vm.hostname = "sasRH7"
...
#   matlabRH7.vm.network "private_network", ip: "192.168.60.157", nic_type: "virtio"
    matlabRH7.vm.provision "shell", :inline => "sudo echo '192.168.60.157 stataRH7.local sasRH7' >> /etc/hosts"
